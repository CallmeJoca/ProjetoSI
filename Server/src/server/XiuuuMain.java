        ...
        do {
            ...
            switch (choice) {
                ...
                case 2: // Querer entrar como cliente
                    ...
                    // Conseguir estabelecer conexão com o servidor entao podemos fazer as operações
                                            ...
                                            do {
                                                ...
                                                switch (clientChoice2) {
                                                    ...
                                                    case 3: //RSA
                                                        ...
                                                        byte[] criptograma2 = activeClient.sendSecret_getSecretBYTE(segredo3);
                                                        String plaintext2 = decryptTextAES(criptograma2, secretKey);
                                                        System.out.println("Segredo recebido!\n ------> " + plaintext2);
                                                    ...
                                                    case 4: // Servidor fornecer chaves
                                                        ...
                                                        SecretKey skFromServer = activeClient.askForNewDistr();

                                                        System.out.println("O que queres sussurrar?");
                                                        String mensagem4 = Read.readString();

                                                        byte[] segredo4 = encryptTextAES(mensagem4, skFromServer);
                                                    ...
                                                    case 5: // Ser um Agente de Confiança
                                                        SecretKey chaves = activeClient.askServerForKeys();

                                                        System.out.println("O que queres sussurrar?");
                                                        String mensagem5 = Read.readString();

                                                        byte[] segredo5 = encryptTextAES(mensagem5, chaves);
                                                        byte[] criptograma4 = activeClient.sendSecret_getSecretBYTE(segredo5);
                                                        String plaintext4 = decryptTextAES(criptograma4, chaves);
                                                        System.out.println("Segredo recebido!\n ------> " + plaintext4);
