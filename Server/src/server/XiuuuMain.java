...
public class XiuuuMain {
        ...
        do {
            ...
            switch(choice) {
                ...
                case 1: // Querer entrar como servidor
                    ...
                    serverDoor = server.Read.readInt();
                ...
                case 2: // Querer entrar como cliente
                    if(newclient) {
                        ...
                        do {
                            ...
                            username = server.Read.readString();
                            
                            System.out.println("Qual o IP do servidor que te vais conectar?");
                            serverIP = server.Read.readString();
                            ...
                            clientDoor = server.Read.readInt();
                            ...
                            enlistcheck = server.Read.readInt();
                    ...
                    do {
                        ...
                        switch(clientChoice1) { //Entrar em que modo de cliente ativo ou passivo, ou fazer pbkdf2
                            ...
                            case 1: // Cliente Ativo
                                ...
                                String whisperTo = server.Read.readString();

                                if(Friends.exist(whisperTo)) {
                                ...
                                //if(activeClient.tryClient(whisperTo, porta
                                    ...
                                    //Dentro do if
                                    if (Cliente_Escrever.touch(serverIP, clientDoor,"")) {
                                        int clientChoice2 = -1;
                                        do {
                                            ...
                                            switch (clientChoice2) {
                                                case 1: // Diffie Hellman
                                                    ...
                                                    //Cliente_Escrever.touch(serverIP, clientDoor,"touching");
                                                    //Cliente_Escrever.loop(serverIP, clientDoor,"loops",debug);
                                                    break;
                            ...
                            case 3: // Fazer PBKDF2
                                ...
                                String passwd = server.Read.readString();
                                
                                server.PBKDF2 alg = new server.PBKDF2();
                                
                                System.out.println("Qual a mensagem que se vai cifrar?");
                                String msg = server.Read.readString();
    ...
    public static void startServer(int serverDoor){
        final int sv = serverDoor;
        new Thread(new Runnable() {
            @Override
            public void run() {
                Cliente_Ouvir.start(sv);
            }
        });
    }

    public static void bothMode(){
        String hostt = null;
        int porrt;
        String portt = null;
        String a;
        ...
        try{
            ...
            try{
                Cliente_Escrever.loop(Friends.read(a),230);
                //non-static method startClient(int) cannot be referenced from a static context
            }catch (Exception e){
                Cliente_Ouvir.start(230);
            }
        }catch(Exception E){
        }
    }
