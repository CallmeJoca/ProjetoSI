...
public class ClienteAtivo extends Cliente {
    ...
    public SecretKey askForNewDistr() throws ClassNotFoundException {
        try {
            // supostamente teriamos de cifrar estas chaves com chaves de sessão
            // fazer as chaves com as Strings pré-definidas?
    ...
    public SecretKey askServerForKeys() throws ClassNotFoundException {
        try {
            ...
            // Usar a chave "servidornospaisdasmaravilhas" como chave
            toServer.writeObject(3);
